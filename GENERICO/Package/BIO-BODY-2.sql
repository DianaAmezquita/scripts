create or replace package body bio is
        ...
        is
          ...
          BEGIN
            ...
            values (id_fingerp,userne,sysdate,phone,sysdate,userne,sysdate,sysdate,userne,null);
        ...
        begin
            ...
            values (id_user,id_logd,una,finger_tem,finger_im,sysdate,una,sysdate,sysdate,una,null);
